...
export const _CosmiconfigSchema = _LoggerSchema.extend({
...
export type Cosmiconfig = z.input<typeof _CosmiconfigSchema>
export const CosmiconfigSchema = ZodAccelerator.build(_CosmiconfigSchema)
